...
public class GetAllVocabularyDTO {
	...
	public GetAllVocabularyDTO() {
	}

	public GetAllVocabularyDTO(Long vocabularyId, String lessonName, String vocabulary, String meaning,
			String imageLink, String example, String exampleMeaning, String exampleImageLink) {
